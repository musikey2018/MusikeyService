...
function PlayListController() {
    ...
    that.incrementSongVote = function (req, res, next) {
        ...
        try {
            ...
            playlist.findOneAndUpdate({"eventId":req.params.eventId, "songs.song.name":songName},{$inc:{"songs.$.votes":1}, $push:{"songs.$.likedBy":likedBy}} ,{ new: 'true'}, function (err, eventDoc) {
                console.log('updated event playlist');
                console.log(eventDoc);
                if (err) {
                    console.log(err);
