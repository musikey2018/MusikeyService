...
function ChatController() {
    ...
    that.registerUserForChat = function (req, res) {
    ...
    that.CreatePrivateChat = function (req, res) {

      var user1email = req.params.email;
      var user1Id =  req.params.userId;
      var user2email = req.params.otheremail;
      var user2Id =  req.params.otheruserId;
