...
function EventsController() {
    ...
    that.createEvent = function (req, res, next) {
        try {
            ...
            events.find({creator: req.params.email, date: new Date(req.params.eventDate), time: req.params.eventTime, location: {type: "Point", coordinates: locationCoords} , city: req.params.eventCity}, function (err, result) {
