...
public class DinnerSearchFragment extends Fragment {
    private static final String TAG = "Dinner Search Fragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.d(TAG, "creating Home view");

        mCtx = getActivity().getApplicationContext();
        try {
            HelperFactory.initializeShakeService(mCtx);
        } catch (Exception ex) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(TAG, "search button is clicked for restaurant query : " + query);
