...
public class NearbyActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private Context mCtx = NearbyActivity.this;
     ...
     * message to avoid it being undelivered due to de-duplication. See {@link NearbyDeviceMessage} for
     * details.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // UUID.
        mPubMessage = NearbyDeviceMessage.newNearbyMessage(getUUID(getSharedPreferences(
        ...
        mMessageListener = new MessageListener() {
            ...
            public void onFound(final Message message) {
                ...
                mNearbyDevicesArrayAdapter.add(
                        NearbyDeviceMessage.fromNearbyMessage(message).getMessageBody());
            }
...
* */
    ...
    private void logAndShowSnackbar(final String text) {
        Log.w(TAG, text);
        View container = findViewById(R.id.activity_nearby_container);
        if (container != null) {
